...
const { Page } =
  VM.require("${REPL_EVENTS}/widget/devhub.entity.addon.blog.Page") ||
  (() => <></>);
...
if (id && !showEditScreenData) {
  return (
    <Widget
      src="${REPL_EVENTS}/widget/devhub.entity.post.Postv2"
      props={{
        postKey: id,
        template: (p) => (
          <Page
...
if (showEditScreenData) {
  return (
    <EditorContainer>
      ...
      <Widget
        src={`${REPL_EVENTS}/widget/devhub.entity.addon.blog.Configurator`}
        props={{
          ...showEditScreenData,
...
return (
  <div className="w-100">
    ...
    <BlogContainer>
      <Widget
        src={"${REPL_EVENTS}/widget/devhub.entity.addon.blog.Viewer"}
        props={{
