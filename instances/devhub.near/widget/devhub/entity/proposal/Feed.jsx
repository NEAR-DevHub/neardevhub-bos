        ...
        <div className="d-flex gap-4 w-100">
          ...
          <div className="d-flex flex-column gap-2 w-100 text-wrap">
            <div className="d-flex gap-2 align-items-center flex-wrap w-100">
              ...
              <Widget
                src={
                  "${alias_REPL_DEVHUB}/widget/devhub.entity.proposal.CategoryTag"
                }
                props={{
...
const getProposal = (proposal_id) => {
  return Near.asyncView("${alias_REPL_DEVHUB_CONTRACT}", "get_proposal", {
    proposal_id,
  });
};
    ...
    <Container className="w-100 py-4 px-2 d-flex flex-column gap-3">
      <div className="d-flex justify-content-between flex-wrap gap-2 align-items-center">
        ...
        <div className="d-flex flex-wrap gap-4 align-items-center">
          <Widget
            src={
              "${alias_REPL_DEVHUB}/widget/devhub.feature.proposal-search.by-input"
            }
            props={{
              search: state.input,
              className: "w-xs-100",
          ...
          <Widget
            src={
              "${alias_REPL_DEVHUB}/widget/devhub.feature.proposal-search.by-sort"
            }
            props={{
          ...
          <div className="d-flex gap-4 align-items-center">
            <Widget
              src={
                "${alias_REPL_DEVHUB}/widget/devhub.feature.proposal-search.by-category"
              }
              props={{
                onStateChange: (select) => {
            ...
            <Widget
              src={
                "${alias_REPL_DEVHUB}/widget/devhub.feature.proposal-search.by-stage"
              }
              props={{
                onStateChange: (select) => {
            ...
            <Widget
              src={
                "${alias_REPL_DEVHUB}/widget/devhub.feature.proposal-search.by-author"
              }
              props={{
