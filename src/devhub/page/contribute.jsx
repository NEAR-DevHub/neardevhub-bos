...
const actions = [
  {
    ...
    ctaLink: "/${REPL_DEVHUB}/widget/app?page=blog&id=2029",
  },
  {
    ...
    ctaAction: "Learn More →",
    ctaLink: "/${REPL_DEVHUB}/widget/app?page=blog&id=2035",
  },
  {
    title: "Host an Event",
    description:
    ...
    ctaAction: "Learn More →",
    ctaLink:
      "/${REPL_DEVHUB}/widget/app?page=community&handle=hacks&tab=wiki-202",
  },
  {
  ...
  },
  {
    ...
    ctaAction: "Learn More →",
    ctaLink:
      "/${REPL_DEVHUB}/widget/app?page=community&handle=fellowship&tab=wiki-1",
  },
  {
    ...
    ctaAction: "Learn More →",
    ctaLink: "/${REPL_DEVHUB}/widget/app?page=community&handle=near-campus",
  },
  {
