    ...
    test("should comment to a long thread with don't ask again feature enabled", async ({
        ...
        await page.evaluate(async () => {
            await new Promise(resolve => {
                ...
                const key = '{"action":"LocalStorage","domain":{"page":"confirm_transactions"},"key":{"widgetSrc":"devhub.near/widget/devhub.entity.post.PostEditor","contractId":"devgovgigs.near","type":"send_transaction_without_confirmation"}}';
