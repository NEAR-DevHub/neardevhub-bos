export async function modifySocialNearGetRPCResponsesInsteadOfGettingWidgetsFromBOSLoader(page) {
    console.log('Getting local widgets by modifying RPC responses from social.near get function, remember to not have the bos loader flags in local storage');
    const devComponents = (
